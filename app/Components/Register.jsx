    ...
    <div className="relative flex justify-center items-center min-h-screen bg-zinc-900/50 backdrop-blur-sm">
      ...
      >
        ...
        <input
          ...
          className="w-full border border-gray-200 p-2 bg-white rounded-full"
        />
        {errors.name && (
        ...
        <select
          ...
          className="w-full border border-gray-300 p-2 rounded-full bg-white"
        >
        ...
        <div className="flex">
   <h1>Already have an account? </h1> <h1 onClick={()=>{setpopUpPage("login")}} className="text-blue-800 pl-1">Sign In</h1>
</div>
        {/* Dots */}
